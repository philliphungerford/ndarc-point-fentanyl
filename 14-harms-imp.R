...
### in predicting harms. That is, fentanyl a significant predictor of a harm that is experienced
...
#results <- mclapply(independent_variables, FUN = glmm_run, mc.cores=length(independent_variables)) # 4 cores needed
...
##############################################################################
# Save
file_name="output/results/13-harms-imp-RI.RData"
